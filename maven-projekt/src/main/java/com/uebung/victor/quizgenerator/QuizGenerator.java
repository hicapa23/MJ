package com.uebung.victor.quizgenerator;
...
public class QuizGenerator {
    public static void main(String[] args) {
        ...
        for (int fragenBogen = 1; fragenBogen <= 35; fragenBogen++) {
            ...
            try (FileWriter fragenBogenWriter = new FileWriter("cuestionario_" + fragenBogen + ".txt");
                    FileWriter schlüsselAntwortWriter = new FileWriter("clave_respuestas_" + fragenBogen + ".txt")) {
